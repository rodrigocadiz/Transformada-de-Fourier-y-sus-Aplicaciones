...
begin
	...
	gif(anim,fps=1,show_msg=false,"difraccion.gif")
...
begin
	...
	gx = -2.5:0.1:2.5;
	rect2D1(x,y) = rect(x/1.2)*rect(y/1.2);
	im1 = rect2D1.(gx,gx');
	im2 = rect2D1.(gx,gx');
	rconv = conv(im1,im2);
	r3 = 
